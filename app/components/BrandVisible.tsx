...
const BrandVisible = () => {
  ...
  return (
    <section ref={sectionRef} className="bg-[#EFEEE9] py-24 px-6 md:px-16 w-full overflow-hidden">
      <div className="max-w-[1400px] mx-auto flex flex-col lg:flex-row items-center justify-between gap-16">
        ...
        <div className="flex-1 w-full">
          <h2 ref={titleRef} className="text-5xl md:text-7xl font-bold leading-[1.1] tracking-tight">
            <span className="text-black block">WE MAKE YOUR</span>
            <span className="text-[#1a3c8e] block">BRAND VISIBLE</span>
          </h2>
        </div>

        {/* Right Content */}
        <div className="flex-1 w-full">
          <p ref={textRef} className="text-[#1a1a1a] text-lg md:text-xl leading-relaxed max-w-2xl ml-auto font-medium">
