...
const HeroSection = () => {
  ...
  />
          ...
          <div className="hidden md:flex items-center gap-8">
            ...
            <button className="px-6 py-2 bg-white text-black rounded-full hover:bg-gray-200 transition-colors flex items-center gap-2">
              Contact
              <svg 
                className="w-4 h-4" 
                fill="none" 
      ...
      <div className="relative z-10 flex items-center justify-center min-h-screen px-6">
        <div className="relative text-center">
          ...
          <div className="absolute -top-8 -right-8 md:-top-12 md:-right-12">
            <svg 
              className="w-6 h-6 md:w-10 md:h-10 text-white animate-spin" 
